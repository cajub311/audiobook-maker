...
# Edge TTS rejects or truncates payloads around 4096 UTF-8 bytes; stay under for reliable audio.
EDGE_TTS_MAX_CHUNK_UTF8_BYTES = _env_int("ABM_EDGE_TTS_MAX_CHUNK_UTF8_BYTES", 3500, minimum=512)
