...
class EdgeTTSEngine(TTSEngine):
    ...
    async def generate(
        ...
        voice_name, pitch_str, _pitch_hz, rate_override = _parse_voice_string(voice)
        ...
        try:
            ...
            communicate = edge_tts.Communicate(text=cleaned, voice=voice_name, rate=rate_str, pitch=pitch_str)
...
class KokoroEngine(TTSEngine):
    ...
    async def generate(
        ...
        try:
            ...
            voice_name, _, _, _ = _parse_voice_string(voice)
